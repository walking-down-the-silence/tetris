...
namespace Silent.Tetris.Contracts
{
    ...
    public interface IDependencyResolver
    {
        ...
        void Register<TService>(Func<IDependencyResolver, object> factoryMethod) where TService : class;
        ...
        /// <param name="serviceName"> The service name. </param>
        /// <param name="factoryMethod"> A factory method to create an instance. </param>
        void Register<TService>(string serviceName, Func<IDependencyResolver, object> factoryMethod) where TService : class;
    }
}